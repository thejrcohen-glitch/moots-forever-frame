...
const NORMALIZED_API_KEY = normalizeOptionalEnvString(API_KEY);
const FORGE_BASE_URL = normalizeOptionalEnvString(import.meta.env.VITE_FRONTEND_FORGE_API_URL);
