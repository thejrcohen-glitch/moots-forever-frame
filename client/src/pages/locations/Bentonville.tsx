...
const RIDE_TIERS = [
  {
    title: "Mountain — OZ Trails",
    note: "Moots Womble, MXC, or Mountaineer",
    href: "https://oztrails.com",
    copy:
      "The OZ Trails network is Bentonville's trail infrastructure — big berms, fast downhill, rocky Ozark tech, and waterfall views. Every skill level, every trail a new chapter.",
  },
  {
    title: "Gravel — The Ozark Roads",
    note: "Moots Routt 45 or Routt CRD",
    href: "https://bigsugarclassic.com",
    copy:
      "The Ozark gravel roads are the reason riders come from everywhere. Rolling, technical, remote. The Big Sugar Classic covers 40 to 60 miles of them every October. The Routt 45 and Routt CRD are built for exactly this.",
  },
  {
    title: "Adventure — Scrambler Country",
    note: "Moots Scrambler",
    copy:
      "When the road ends and the trail begins, that's Scrambler territory. Bikepacking mounts, full cargo capacity, and titanium that outlasts everything else in the bag. Northwest Arkansas overnights start here.",
  },
] as const;

const EVENTS = [
  {
    name: "Big Sugar Classic MTB",
    details: "October 11, 2026. bigsugarclassic.com",
  },
  {
    name: "Big Sugar Classic Gravel",
    details: "October 17, 2026. bigsugarclassic.com",
  },
  {
    name: "Backyard Bash",
    details:
      "Labor Day Weekend. 40 or 60 miles Ozark gravel. Finishes at The Hub Bike Lounge, downtown Bentonville. bigsugarclassic.com/backyard-bash",
  },
] as const;

const RESOURCES = [
  { label: "OZ Trails", href: "https://oztrails.com" },
  { label: "OZ Trails Bike Park", href: "https://oztrailsbikepark.com" },
  { label: "NWA Trails", href: "https://nwatrails.com" },
  { label: "Big Sugar Classic", href: "https://bigsugarclassic.com" },
  { label: "NUE Series", href: "https://nuemtb.com" },
] as const;
...
export default function Bentonville() {
  useEffect(() => {
    const title = "Bentonville — MootsFrame";
    const description =
      "Bentonville and Northwest Arkansas location page for MootsFrame. Ozark gravel, world-class singletrack, events, and service-area contact.";
    ...
    setMetaContent('meta[property="og:url"]', "https://mootsframe.com/locations/bentonville");
    ...
    <main className="min-h-screen" style={{ background: "oklch(0.22 0.01 60)" }}>
      <article className="py-24">
        <div className="container max-w-5xl">
          <SectionLabel>Bentonville</SectionLabel>
          <h1 className="font-display text-5xl md:text-6xl font-bold mb-5" style={{ color: "oklch(0.945 0.018 78)" }}>
            Bentonville: Where the Dirt Decides Everything
          </h1>
          <p className="font-display text-2xl md:text-3xl font-bold mb-6" style={{ color: READABLE_ACCENT }}>
            Ozark gravel. World-class singletrack. One frame for all of it.
          </p>
          <p className="font-mono-custom text-base md:text-lg leading-loose max-w-4xl" style={{ color: "oklch(0.78 0.03 70)" }}>
            Bentonville doesn't pick a lane. The OZ Trails network built the benchmark for destination mountain biking. The Ozark gravel roads built the riders. The same titanium frame that handles Big Sugar on October 17th handles the singletrack on October 11th. One frame. Every chapter.
          </p>
        </div>
      </article>
            ...
            <DarkCard key={tier.title} title={tier.title} note={tier.note}>
              ...
              {"href" in tier ? (
                <a
                  ...
                  className="font-label text-xs tracking-[0.18em] uppercase hover:opacity-70 transition-opacity focus:outline focus:outline-2 focus:outline-offset-4"
      ...
      <section className="container py-16 border-t" style={{ borderColor: "oklch(0.38 0.015 60 / 0.5)" }}>
        <div className="max-w-4xl mb-9">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mb-4" style={{ color: "oklch(0.945 0.018 78)" }}>
            Demo a Moots in Bentonville
          </h2>
          <p className="font-mono-custom text-base md:text-lg leading-loose" style={{ color: "oklch(0.78 0.03 70)" }}>
            Ian Zakrocki represents Moots titanium bikes across Texas, Arkansas, and Oklahoma. Demo rides available in the Bentonville and Northwest Arkansas area.
          </p>
        </div>
