...
const RIDE_TIERS = [
  {
    title: "Downhill — Spider Mountain",
    note: "Moots Womble, MXC, or Mountaineer",
    copy:
      "The only lift-served, year-round downhill bike resort in the United States. Texas Eagle chairlift. 350 vertical feet. Beginner through expert lines. Burnet, TX on Lake Buchanan. Friday through Sunday. spidermountain.com",
  },
  {
    title: "Singletrack — Reimers Ranch and Reveille Peak",
    note: "Moots Routt YBB or Womble",
    copy:
      "Milton Reimers Ranch in Dripping Springs offers 18 miles of rocky limestone singletrack along the Pedernales River. Free county park. Reveille Peak Ranch near Marble Falls runs technical granite slickrock and cross-country loops on massive rock outcroppings.",
  },
  {
    title: "Gravel — The Castell Grind",
    note: "Moots Routt 45 or Routt CRD",
    copy:
      "Sixty-two miles of remote Hill Country ranch roads from Castell, TX. Rolling terrain, cattle guards, low-water crossings, and the Llano River. Cult-favorite annual event. Sells out in under an hour. castellgrind.com",
  },
  {
    title: "Road — Creek Road and the Hill Country Corridor",
    note: "Moots Vamoots RCS",
    copy:
      "Creek Road in Dripping Springs parallels Onion Creek through working ranches and limestone bluffs. The roads west toward Wimberley, Blanco, and Fredericksburg are low-traffic sustained rollers through wine country. The best road cycling terrain in Texas.",
  },
  {
    title: "Adventure — Pipe Creek and Bandera County",
    note: "Moots Scrambler",
    copy:
      "The ranch roads climbing out of Pipe Creek and Bandera County are the premier testing ground for self-supported endurance gravel loops. Remote. Minimal traffic. No services for miles.",
  },
] as const;
...
const EVENTS = [
  {
    name: "Castell Grind",
    details: "April 11 annually. Castell, TX. 62, 45, or 31 miles. Remote Hill Country gravel. castellgrind.com",
  },
  {
    name: "Spider Mountain",
    details: "Friday through Sunday, year-round. Burnet, TX. spidermountain.com",
  },
] as const;

const RESOURCES = [
  { label: "Spider Mountain", href: "https://spidermountain.com" },
  { label: "Castell Grind", href: "https://castellgrind.com" },
  { label: "Reveille Peak Ranch", href: "https://reveillepeakranch.com" },
] as const;
...
export default function HillCountry() {
  useEffect(() => {
    const title = "Texas Hill Country — MootsFrame";
    const description =
      "Texas Hill Country location page for MootsFrame. Lift-served downhill, granite gravel, ranch roads, events, and service-area contact.";
    ...
    setMetaContent('meta[property="og:url"]', "https://mootsframe.com/locations/hill-country");
    ...
    <main className="min-h-screen" style={{ background: "oklch(0.22 0.01 60)" }}>
      <article className="py-24">
        <div className="container max-w-5xl">
          <SectionLabel>Texas Hill Country</SectionLabel>
          <h1 className="font-display text-5xl md:text-6xl font-bold mb-5" style={{ color: "oklch(0.945 0.018 78)" }}>
            Texas Hill Country: Every Bike. Every Road.
          </h1>
          <p className="font-display text-2xl md:text-3xl font-bold mb-6" style={{ color: READABLE_ACCENT }}>
            Lift-served downhill. Granite gravel. Ranch roads. One corridor covers it all.
          </p>
          <p className="font-mono-custom text-base md:text-lg leading-loose max-w-4xl" style={{ color: "oklch(0.78 0.03 70)" }}>
            The Hill Country does not pick a discipline. Sixty miles northwest of Austin, Spider Mountain runs lift-served downhill on Lake Buchanan. Thirty miles west, the Castell Grind sends riders into the middle of nowhere on 62 miles of remote ranch gravel. The roads between Dripping Springs and Fredericksburg are the ones that built Texas road cycling. One titanium frame earns its keep across all of it.
          </p>
        </div>
      </article>
      ...
      <section className="container py-16 border-t" style={{ borderColor: "oklch(0.38 0.015 60 / 0.5)" }}>
        <div className="max-w-4xl mb-9">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold" style={{ color: "oklch(0.945 0.018 78)" }}>
            Five ways the Hill Country rides.
          </h2>
        </div>
      ...
      <section className="container py-16 border-t" style={{ borderColor: "oklch(0.38 0.015 60 / 0.5)" }}>
        <div className="max-w-4xl mb-9">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mb-4" style={{ color: "oklch(0.945 0.018 78)" }}>
            Demo a Moots in the Hill Country
          </h2>
          <p className="font-mono-custom text-base md:text-lg leading-loose" style={{ color: "oklch(0.78 0.03 70)" }}>
            Ian Zakrocki represents Moots titanium bikes across Texas, Arkansas, and Oklahoma. Demo rides available across the Hill Country corridor.
          </p>
        </div>
