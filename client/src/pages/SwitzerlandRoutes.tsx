...
const WATCH_ROAD_SIGNALS = [
  ...
  {
    title: "Geneva start signal",
    status: "Route signal",
    region: "Geneva",
    territory: "Beyond Territory",
    sourceName: "Switzerland Tourism — Geneva",
    sourceUrl: "https://www.myswitzerland.com/en-us/destinations/geneva/",
    note: "A city-edge start signal for the Switzerland board.",
  },
  {
    title: "Nyon / Lake Geneva edge",
    status: "Route signal",
    region: "Nyon / Lake Geneva",
    territory: "Beyond Territory",
    sourceName: "Switzerland Mobility National Cycling Routes",
    sourceUrl: "https://schweizmobil.ch/en/cycling-in-switzerland/route-7",
    note: "Lake Geneva edge context for the Jura route signal.",
  },
  {
    ...
    region: "Canton Vaud",
    territory: "Beyond Territory",
    sourceName: "Switzerland Tourism — Vallée de Joux",
    sourceUrl: "https://www.myswitzerland.com/en-us/destinations/vallee-de-joux/",
    note: "A quiet valley signal tied to Lac de Joux and watchmaking country.",
  },
  {
  ...
  {
    title: "Le Sentier / Lac de Joux",
    status: "Watchmaking region",
    region: "Le Sentier / Vallée de Joux",
    territory: "Beyond Territory",
    sourceName: "Switzerland Tourism — Vallée de Joux",
    sourceUrl: "https://www.myswitzerland.com/en-us/destinations/vallee-de-joux/",
    note: "Quiet road context near Lac de Joux and the Swiss watchmaking valley.",
  },
  {
    title: "Swiss Jura watchmaking corridor",
    status: "Watchmaking region",
    region: "Swiss Jura",
    territory: "Beyond Territory",
    ...
    note: "A source-backed corridor between the watch towns and the Jura roads.",
  },
  {
    ...
    sourceName: "Switzerland Tourism — On the trail of watches",
    sourceUrl: "https://www.myswitzerland.com/en-us/experiences/on-the-trail-of-watches/",
    note: "A public watch-road signal in the Swiss Jura.",
  },
];
...
const ROUTE_SOURCE_MAPS = [
  {
    ...
    status: "Route signal",
    sourceUrl: "https://www.andermatt.ch/en/summer/cycling/",
    mapUrl: "https://www.google.com/maps?q=Furka%20Pass%20Andermatt%20Switzerland&z=10&output=embed",
  ...
  },
  {
    ...
    status: "Route signal",
    sourceUrl: "https://schweizmobil.ch/en/cycling-in-switzerland/route-7",
    mapUrl: "https://www.google.com/maps?q=Nyon%20Basel%20SchweizMobil%20Route%207%20Switzerland&z=8&output=embed",
  ...
  },
  {
    ...
    status: "Route signal",
    sourceUrl: "https://schweizmobil.ch/en/cycling-in-switzerland/route-1",
    mapUrl: "https://www.google.com/maps?q=Geneva%20Lausanne%20SchweizMobil%20Route%201%20Switzerland&z=8&output=embed",
  ...
  },
  {
    ...
    status: "Route signal",
    sourceUrl: "https://schweizmobil.ch/en/cycling-in-switzerland/route-2",
    mapUrl: "https://www.google.com/maps?q=Basel%20SchweizMobil%20Route%202%20Switzerland&z=8&output=embed",
  ...
  },
  {
    ...
    status: "Watchmaking region",
    sourceUrl: "https://whc.unesco.org/en/list/1302/",
    mapUrl: "https://www.google.com/maps?q=La%20Chaux-de-Fonds%20Le%20Locle%20Switzerland&z=11&output=embed",
  ...
  },
  {
    ...
    status: "Watchmaking region",
    sourceUrl: "https://www.myswitzerland.com/en-us/destinations/vallee-de-joux/",
    mapUrl: "https://www.google.com/maps?q=Vall%C3%A9e%20de%20Joux%20Switzerland&z=11&output=embed",
  ...
  },
  {
    ...
    status: "Route signal",
    sourceUrl: "https://maps.andermatt.swiss/",
    mapUrl: "https://www.google.com/maps?q=Andermatt%20Hospental%20Switzerland&z=11&output=embed",
