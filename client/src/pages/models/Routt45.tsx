...
const PAGE_URL = "https://mootsframe.com/bikes/routt-45";
const TITLE = "Moots Routt 45 — MootsFrame";
const DESCRIPTION =
  "Demo the Moots Routt 45 titanium gravel bike in Texas, Arkansas, and Oklahoma. Available through MootsFrame, the territory dealer.";
...
export default function Routt45() {
  useRoutt45Metadata();
    ...
    <main className="min-h-screen" style={{ background: "oklch(0.22 0.01 60)" }}>
        ...
        <div className="container max-w-6xl space-y-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
              One bike for anything the territory throws at you.
            </p>
          </div>

          <img
            src={HERO_IMAGE}
            alt="Moots Routt 45 titanium all-road gravel bike"
            loading="lazy"
          ...
          <div className="grid gap-6 lg:grid-cols-[1.35fr_0.95fr]">
            <div className="p-6 md:p-8" style={{ background: DARK_BG, border: DARK_BORDER }}>
              <p className="font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
                Built for the roads that don't have names. The Routt 45 is Moots' all-road gravel bike — relaxed geometry,
                45mm tire clearance, and the titanium ride quality that makes long days feel shorter. Named for Routt
                County Road 45 in Steamboat Springs. Handbuilt there since 1981.
              </p>
            </div>
            <div className="p-6 md:p-8" style={{ background: DARK_BG, border: DARK_BORDER }}>
      ...
      <section className="pb-20">
        <div className="container max-w-6xl">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
              Barker Reservoir levees. Chappell Hill Gravel Grinder. Sam Houston National Forest fire roads. The Mid South
              in Stillwater. Bentonville R3 gravel routes. This frame earns its keep across the full TX/AR/OK territory.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-12">
        <div className="container max-w-6xl flex flex-col gap-4">
          <a
            href="https://moots.com/products/routt-45"
            target="_blank"
            rel="noopener noreferrer"
