...
const HERO_IMAGE =
  "https://moots.com/cdn/shop/files/VAMOOTS3301_b78e3299-71c6-4c99-b3a7-8ec5020b9756.jpg?v=1760652262";
const PAGE_URL = "https://mootsframe.com/bikes/vamoots-33";
const TITLE = "Moots Vamoots 33 — MootsFrame";
const DESCRIPTION =
  "Demo the Moots Vamoots 33 titanium all-road bike in Texas, Arkansas, and Oklahoma. Available through MootsFrame.";
...
const PRODUCT_SCHEMA = {
  ...
  "@type": "Product",
  name: "Moots Vamoots 33",
  description:
    "The Moots Vamoots 33 is a titanium all-road bike built for any-condition riding. Hand-built in Steamboat Springs, Colorado. Available for demo in Texas, Arkansas, and Oklahoma through MootsFrame.",
  brand: {
    "@type": "Brand",
    name: "Moots",
    url: "https://moots.com",
...
function useVamoots33Metadata() {
  useEffect(() => {
    ...
    const schemaId = "vamoots-33-product-json-ld";
...
export default function Vamoots33() {
  useVamoots33Metadata();
    ...
    <main className="min-h-screen" style={{ background: "oklch(0.22 0.01 60)" }}>
      <section className="pt-24 pb-20">
        <div className="container max-w-6xl space-y-8">
          ...
          <img
            src={HERO_IMAGE}
            alt="Moots Vamoots 33 titanium all-road bike"
            loading="lazy"
          ...
          <div className="grid gap-6 lg:grid-cols-[1.35fr_0.95fr]">
            <div className="p-6 md:p-8" style={{ background: DARK_BG, border: DARK_BORDER }}>
              <p className="font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
                Named for Routt County Road 33 — where smooth tarmac meets chip seal and gravel. The Vamoots 33 is built
                for riders who want an any-condition road bike. 3D-printed flat-mount brake hardware and in-house machined
                dropouts for precision. Confident on smooth roads, capable when the surface changes.
              </p>
            </div>
            <div className="p-6 md:p-8" style={{ background: DARK_BG, border: DARK_BORDER }}>
              <dl className="grid gap-4">
                {[
                  ["Material", "Titanium 3Al/2.5V alloy"],
                  ["Category", "All-Road / Endurance Road"],
      ...
      <section className="pb-20">
        <div className="container max-w-6xl">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
              Texas back roads that can't decide what they are. Ranch roads, chip seal, the occasional gravel stretch. The
              Vamoots 33 handles the full spectrum without asking you to choose.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-12">
        <div className="container max-w-6xl flex flex-col gap-4">
          <a
            href="https://moots.com/products/vamoots-33"
            target="_blank"
            rel="noopener noreferrer"
