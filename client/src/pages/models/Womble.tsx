...
const HERO_IMAGE = "https://moots.com/cdn/shop/files/Womble1.jpg?v=1760712773";
const PAGE_URL = "https://mootsframe.com/bikes/womble";
const TITLE = "Moots Womble — MootsFrame";
const DESCRIPTION =
  "Demo the Moots Womble titanium mountain bike in Texas, Arkansas, and Oklahoma. Available through MootsFrame.";
...
const PRODUCT_SCHEMA = {
  ...
  name: "Moots Womble",
  description:
    "The Moots Womble is a titanium XC/downcountry mountain bike with 29-inch wheels and 140mm fork travel. Hand-built in Steamboat Springs, Colorado. Available for demo in Texas, Arkansas, and Oklahoma through MootsFrame.",
  brand: {
    "@type": "Brand",
    name: "Moots",
    url: "https://moots.com",
...
function useWombleMetadata() {
  useEffect(() => {
    ...
    const schemaId = "womble-product-json-ld";
...
export default function Womble() {
  useWombleMetadata();
    ...
    <main className="min-h-screen" style={{ background: "oklch(0.22 0.01 60)" }}>
        ...
        <div className="container max-w-6xl space-y-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
              XC speed. Downcountry energy.
            </p>
          </div>

          <img
            src={HERO_IMAGE}
            alt="Moots Womble titanium mountain bike"
            loading="lazy"
          ...
          <div className="grid gap-6 lg:grid-cols-[1.35fr_0.95fr]">
            <div className="p-6 md:p-8" style={{ background: DARK_BG, border: DARK_BORDER }}>
              <p className="font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
                The Womble is where XC efficiency meets downcountry energy. Built around modern 29-inch geometry with a
                140mm fork and room for up to a 2.6-inch tire. Short rear end — so you don't have to choose between fast
                and rowdy. UDH dropouts standard.
              </p>
            </div>
            <div className="p-6 md:p-8" style={{ background: DARK_BG, border: DARK_BORDER }}>
              <dl className="grid gap-4">
                {[
                  ["Material", "Titanium 3Al/2.5V alloy"],
                  ["Category", "XC / Downcountry Mountain"],
                  ["Wheel Size", '29"'],
                  ["Fork Travel", "140mm"],
      ...
      <section className="pb-20">
        <div className="container max-w-6xl">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
              Terry Hershey Anthills. Memorial Park MTB. Cypress Creek singletrack. The Womble handles the Houston trail
              network and every technical loop in the territory.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-12">
        <div className="container max-w-6xl flex flex-col gap-4">
          <a
            href="https://moots.com/products/womble"
            target="_blank"
            rel="noopener noreferrer"
