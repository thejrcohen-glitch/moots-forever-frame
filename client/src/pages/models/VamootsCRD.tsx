...
const HERO_IMAGE =
  "https://moots.com/cdn/shop/files/1_f5eb9d0a-8c46-4883-923d-94135a08dbb4.png?v=1770311135";
const PAGE_URL = "https://mootsframe.com/bikes/vamoots-crd";
const TITLE = "Moots Vamoots CRD — MootsFrame";
const DESCRIPTION =
  "Demo the Moots Vamoots CRD race road bike in Texas, Arkansas, and Oklahoma. Available through MootsFrame.";
...
const PRODUCT_SCHEMA = {
  ...
  "@type": "Product",
  name: "Moots Vamoots CRD",
  description:
    "The Moots Vamoots CRD is the Complete Race Design titanium road bike, built on the RSL tube set with 3D-printed dropouts. Hand-built in Steamboat Springs, Colorado. Available for demo in Texas, Arkansas, and Oklahoma through MootsFrame.",
  brand: {
    "@type": "Brand",
    name: "Moots",
    url: "https://moots.com",
...
function useVamootsCRDMetadata() {
  useEffect(() => {
    ...
    const schemaId = "vamoots-crd-product-json-ld";
...
export default function VamootsCRD() {
  useVamootsCRDMetadata();
    ...
    <main className="min-h-screen" style={{ background: "oklch(0.22 0.01 60)" }}>
        ...
        <div className="container max-w-6xl space-y-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
              Road racing built to last a lifetime.
            </p>
          </div>

          <img
            src={HERO_IMAGE}
            alt="Moots Vamoots CRD Complete Race Design titanium road bike"
            loading="lazy"
          ...
          <div className="grid gap-6 lg:grid-cols-[1.35fr_0.95fr]">
            <div className="p-6 md:p-8" style={{ background: DARK_BG, border: DARK_BORDER }}>
              <p className="font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
                At the pinnacle of the Moots road line. The Vamoots CRD uses the double-butted RSL titanium tube set with
                3D-printed dropouts for exact brake alignment and stiffness. Light, responsive, and smooth in every detail.
                A road racing frame that outlasts the competition.
              </p>
            </div>
            <div className="p-6 md:p-8" style={{ background: DARK_BG, border: DARK_BORDER }}>
      ...
      <section className="pb-20">
        <div className="container max-w-6xl">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="font-mono-custom text-sm md:text-base leading-loose" style={{ color: WARM_TEXT }}>
              For riders in the territory who race. The criteriums, the road centuries, the fast club rides in DFW and
              Austin. When road performance is the goal, the CRD is the answer.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-12">
        <div className="container max-w-6xl flex flex-col gap-4">
          <a
            href="https://moots.com/products/vamoots-crd"
            target="_blank"
            rel="noopener noreferrer"
