...
export default function Bikes() {
  useEffect(() => {
    ...
    script.textContent = JSON.stringify({
      ...
      description:
        "The Moots Routt RSL is Moots' race-spec titanium gravel bike. Lighter, stiffer, and built for competitive gravel riding. Hand-built in Steamboat Springs, Colorado. Available for demo in Texas, Arkansas, and Oklahoma through MootsFrame.",
      brand: {
        "@type": "Brand",
        name: "Moots",
        url: "https://moots.com",
      },
      image: "https://moots.com/cdn/shop/files/RouttRSLStanley01.jpg",
      url: "https://mootsframe.com/models/routt-rsl",
      manufacturer: {
        "@type": "Organization",
        name: "Moots",
        address: {
