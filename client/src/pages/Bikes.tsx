...
export default function Bikes() {
  useEffect(() => {
    ...
    script.textContent = JSON.stringify({
      ...
      description:
        "The Moots Routt YBB features Moots' titanium rear suspension design for rough gravel and long days in the saddle. Hand-built in Steamboat Springs, Colorado. Available for demo in Texas, Arkansas, and Oklahoma through MootsFrame.",
      brand: {
        "@type": "Brand",
        name: "Moots",
        url: "https://moots.com",
      },
      image: "https://cdn.shopify.com/s/files/1/0049/1612/files/YBB_UDH.jpg?v=1762966604",
      url: "https://mootsframe.com/models/routt-ybb",
      manufacturer: {
        "@type": "Organization",
        name: "Moots",
        address: {
